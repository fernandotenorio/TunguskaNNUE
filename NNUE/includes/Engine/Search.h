...
#include <vector>
#include <chrono>
#include "nnue_loader.h" // Include the NNUE header
...
class Search{
	private:
		...
		// NNUE related members
		NNUELoader& model;

	public:
		static const int INFINITE;
		static const int ASPIRATION_START_DEPTH;
		static const int REDUCTION_LIMIT;
		static const int REDUCTION_DEPTH_LATE;
		static const int IID_REDUCTION;
